...
class AddLambdaNaiveBayesTrainer[Label,Feature,Value](lambda: Double/*,featExt: FeatureExtender[Feature,Value]*/) extends NaiveBayesTrainerToImplement[Label,Feature,Value] {
